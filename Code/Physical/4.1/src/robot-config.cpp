...
motor intake2 = motor(PORT1, ratio6_1, false);
motor shoot1 = motor(PORT9, ratio6_1, true);
motor shoot2 = motor(PORT8, ratio6_1, true);
...
encoder leftEncoder = encoder(Brain.ThreeWirePort.D);//E
encoder rightEncoder = encoder(Brain.ThreeWirePort.G);//H
